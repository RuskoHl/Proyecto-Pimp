            ...
            switch ($eventType) {
                case 'payment.created':
                    ...
                    if (isset($payload['data']['id'], $payload['data']['date_created'])) {
                        ...
                        // Obtener el ID del pago si está presente
                        $paymentId = $payload['data']['id'] ?? null;
                
                        if ($paymentId) {
                            // Intentar obtener información adicional mediante una consulta a la API de Mercado Pago
                            ...
                            if (isset($informacionPago['data'])) {
                                ...
                                // Registrar información del evento en los logs
                                Log::info("Evento de pago creado - ID: $paymentId, Información adicional obtenida: " . json_encode($paymentData));
                            } else {
